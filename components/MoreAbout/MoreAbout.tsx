  ...
  return (
    <Section id="more" className="bg-neutral-500">
      ...
      <p className="text-white drop-shadow-sm mb-6">
        Odkryj różnorodność i emocje w <span className="text-yellow-300 drop-shadow-sm">Palladium Fitness Club</span>! U
        nas znajdziesz nie tylko siłownię, ale także szereg innych aktywności,
        takich jak boks, zajęcia taneczne, funkcjonalne ciało, muay thai,
        speedball i interval class. Dołącz do nas już teraz i ciesz się pasją,
        wyzwaniami i radością, jakie oferuje nasze klubowe doświadczenie
        fitness!
      </p>
