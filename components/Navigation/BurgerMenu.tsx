...
const BurgerMenu: FC<BurgerMenu> = ({ children, isOpen, toggleOpen }) => {
  return (
    <>
      ...
      <div
        className={`absolute transition-all filter duration-300 delay-75 left-0 top-0 w-screen h-screen bg-neutral-700 items-center justify-center ${
          isOpen ? "slideIn flex" : "hidden"
        } `}
      >
